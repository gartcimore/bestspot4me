...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    ...
    port:     27017,
    ssl:      false,
    url:      'mongodb://localhost:27017/bestSpot4Me',
...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'vagrant',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'vagrant',
  },
